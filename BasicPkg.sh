...
echo "Creater Name IMTIAZ"
echo "Has IMTIAZ-X made"
...
figlet -f slant 'IMTIAZ' |lolcat
echo
echo
echo 
figlet -f slant 'Has IMTIAZ-X  made' |lolcat
echo
echo
echo 
figlet -f slant 'Creater By IMTIAZ' |lolcat
echo
echo
echo 
